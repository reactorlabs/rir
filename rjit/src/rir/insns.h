...
/**
 * ldfun_:: take immediate CP index of symbol, find binding in env and push value
 */
...
/**
 * pusharg_:: take immediate index of an argument, read argument value and push it on object stack
 */
...
/**
 * stvar_:: pop a symbol and a value off object stack, define a variable and push value on object stack
 */
